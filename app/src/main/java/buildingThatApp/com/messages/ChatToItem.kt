...
class ChatToItem(val text: String, val userPhoto: String) : Item<GroupieViewHolder>() {
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        val imageView = viewHolder.itemView.findViewById<ImageView>(R.id.current_user_chat_imageview)
